...
class PetMessageController {
  private final PetMessageRepository messages; private final PetProfileRepository profiles;
  PetMessageController(PetMessageRepository messages,PetProfileRepository profiles){this.messages=messages;this.profiles=profiles;}
