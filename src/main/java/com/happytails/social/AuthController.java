...
public class AuthController {
  ...
  private String permission(String s){String v=s==null?"EVERYONE":s.trim().toUpperCase();return Set.of("EVERYONE","FOLLOWING","NOBODY").contains(v)?v:"EVERYONE";}
