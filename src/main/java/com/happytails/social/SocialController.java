...
public class SocialController {
  ...
  @PostMapping("/friend-requests") public ResponseEntity<FriendRequest> request(@RequestBody FriendRequest r){return ResponseEntity.status(201).body(requests.save(r));}
  ...
  @PostMapping("/play-dates") public ResponseEntity<PlayDate> playDate(@RequestBody PlayDate p){return ResponseEntity.status(201).body(playDates.save(p));}
